$(document).ready(function(){
  ...
  function minutes_ring() {
    minutes.style[Modernizr.prefixed('transform')] = 'translateZ( -370px ) rotateY(' + -6 * time()/60 + 'deg)';
  }
  function hours_ring() {
    hours.style[Modernizr.prefixed('transform')] = 'translateZ( -300px ) rotateY(' + -15 * ((time()/3600)-8) + 'deg)';
  }
  function set_clock(){
